...
namespace Alan 
{
	public sealed class ResourceDemo : MonoBehaviour 
	{
        ...
        private void OnGUI()
        {
            ...
            {
                App.Resource.LoadAsync(new ResourceAssetInfo("test",null,true),
            ...
            {
                App.Resource.LoadAsync(new AssetsBundleAssetInfo(Application.streamingAssetsPath+"/test", "test", null, true),
            ...
            {
                App.Resource.Unload(Application.streamingAssetsPath + "/test");
            }

            if (GUILayout.Button("卸载AB包和已经加载的资源"))
            {
                App.Resource.Unload(Application.streamingAssetsPath + "/test",true);
            }
