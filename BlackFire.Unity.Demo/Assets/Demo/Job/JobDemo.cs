...
using Utility = BlackFire.Unity.Utility;
	...
	public sealed class JobDemo : MonoBehaviour 
	{
        ...
        private void Awake()
        {
            ...
            Job.StartLongNew(state=> {
                ...
                m_HttpServer = BlackFire.Utility.Http.CreateHttpServer(new BlackFire.Utility.Http.LazyHttpServerInfo(getData => {
        ...
        private BlackFire.Utility.Http.HttpServer m_HttpServer;
