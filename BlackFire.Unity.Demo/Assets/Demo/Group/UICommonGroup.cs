...
namespace Alan
{
    ...
    public sealed class UICommonTestGroupMember : Organize.GroupMember, ISingleGroupMemberCommandTest,
        IMultiGroupMemberCommandTest
    {
    ...
    public interface ITestSingleGroupMemberCommand : BlackFire.Event.IEventHandler
    {

    }

    public interface ITestMultiGroupMemberCommand : BlackFire.Event.IEventHandler
    {

    }

    public interface ITestGroupCommand : BlackFire.Event.IEventHandler
    {
